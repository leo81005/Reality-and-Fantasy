...
import argparse
import time
from utils.parse import des_prompt_text, more_prompt_text
        ...
        if response is None:
            ...
            while True:
                ...
                try:
                    ...
                    raw_gen_boxes, bg_prompt, neg_prompt, des_prompt, more_prompt = parsed_input
